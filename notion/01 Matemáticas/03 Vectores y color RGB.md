...
- [MIT: *Foundations of Computer Vision*](https://visionbook.mit.edu/) — libro en línea gratuito para conectar color, imágenes y geometría; sus capítulos posteriores son avanzados.

**Libro comercial opcional**

- [Lay, Lay y McDonald, *Linear Algebra and Its Applications*, 6.ª ed.](https://www.pearson.com/en-us/subject-catalog/p/linear-algebra-and-its-applications/P200000006235) — desarrollo extenso de vectores y álgebra lineal. Los ejercicios de esta clase no dependen del libro.
